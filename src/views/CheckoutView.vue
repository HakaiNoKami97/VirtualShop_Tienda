      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="mb-5 d-flex justify-content-between flex-column flex-lg-row"><a class="btn btn-link text-muted" href="checkout3.html"> <i class="fa fa-angle-left me-2"></i>Back to the delivery method</a><a class="btn btn-dark" href="checkout5.html">Place an order<i class="fa fa-angle-right ms-2"></i></a></div>
          </div>
          <div class="col-lg-4">
            <div class="block mb-5">
              <div class="block-header">
